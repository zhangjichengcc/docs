<!--
 * @Author: zhangjicheng
 * @Date: 2021-06-03 16:27:56
 * @LastEditTime: 2021-07-22 17:00:07
 * @LastEditors: Please set LastEditors
 * @Description: 
 * @FilePath: \my-note\src\6_工程化\Webpack\11.webpack-dev-server.md
...
我们看一下 webpack-dev-server 的相关配置。
...
webpack-dev-server 的 proxy 功能是使用 http-proxy-middleware 来实现的，如果需要更详细的 proxy 配置，可以参考官方文档 [http-proxy-middleware](https://github.com/chimurai/http-proxy-middleware#example)。
...
> webpack-dev-server 的配置项比较多，这里只列举了一些日常比较有用的，更多的请参考官方文档 [webpack-dev-server](https://webpack.js.org/configuration/dev-server/)。

## webpack-dev-middleware

中间件就是在 [Express](https://expressjs.com/) 或者 [Koa](https://koajs.com/) 之类的 Web 框架中实现各种各样功能（如静态文件访问）的这一部分函数。多个中间件可以一起协同构建起一个完整的 Web 服务器。
...
介绍了 webpack-dev-server 的一些配置选项，同时也介绍了如何使用 webpack-dev-middleware 来将 webpack 的开发环境集成到现有的 Node 服务中，以及如何在 webpack-dev-server 和 webpack-dev-middleware 的基础上实现简单的 mock 服务，希望这些内容可以帮助读者们更好地优化自己项目的本地开发环境，让开发更有效率。
